...
class BottomBarScreenThree extends StatefulWidget {
  var data;

  BottomBarScreenThree({this.data});

  @override
  _BottomBarScreenState createState() => _BottomBarScreenState();
}

class _BottomBarScreenState extends State<BottomBarScreenThree> {
  ...
  Widget build(BuildContext context) {
    final List<Widget> _screens = [
      ...
      RoomsListNew(),
      OnlineCheckIn(),
      OtherDetailPage(data: widget.data,),
    ];
          ...
          body: Column(
            children: [
              _selectedIndex == 0
                ...
                Container(
                  width: width / 1.7, // Adjust width as needed
                  color: Colors.white,
                  child: Center(
                    child: Text(
                      name,
